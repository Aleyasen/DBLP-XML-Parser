...
public class DBLPParserThirdSchema {
    ...
    static String author_conf_path = "data/output3/author_conf.txt";
    static String title_year_path = "data/output3/title_year.txt";
...
//            List<String> types = Arrays.asList("inproceedings");
            ...
            titlesCollection.writeToFile("data/output3/title.txt");
            authorsCollection.writeToFile("data/output3/author.txt");
            confsCollection.writeToFile("data/output3/conf.txt");
            yearConfsCollection.writeToFile("data/output3/year-with-conf.txt");
            yearConfsCollection.writeToFileJustFirsToken("data/output3/year.txt");
