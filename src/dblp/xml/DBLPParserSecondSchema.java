...
import static dblp.xml.DBLPParserSchema.conf_filter_path;
...
public class DBLPParserSecondSchema extends DBLPParserSchema {
    ...
    static String outputDir = "output_y2005_conf50_schema2";
    static String title_author_path = "data/" + outputDir + "/title_author.txt";
    static String author_conf_path = "data/" + outputDir + "/author_conf.txt";
...
//        final List<Integer> authors = parser.getNeighbourEntities(titles, title_author, 1);
        final List<Integer> years = parser.getNeighbourEntities(titles, title_year, 1);
        final List<Integer> confs = parser.getNeighbourEntities(topAuthors, author_conf, 1);
        ...
        parser.writeEdgesToFile(topAuthors, author_conf, 0, "data/" + dir + "/author_conf.txt");
